...
const gb_rgb_t gb_event_colors[gb_event_color_count] = {
    {110,110,115},
    {80,130,190},
    {210,170,80},
    {200,90,100},
...
static gb_event_register_map_t gb_event_registers_map[0x100] = {0};

static void gb_init_event_registers_map(){
    ...
    gb_event_registers_map[0x00] = joypad;
    ...
    gb_event_registers_map[0x01] = serial;
    gb_event_registers_map[0x02] = serial;
    ...
    for(int i = 0x04; i <= 0x07; ++i){
        gb_event_registers_map[i] = timer;
    }
    ...
    gb_event_registers_map[0x0F] = interrupt;
    gb_event_registers_map[0xFF] = interrupt;
    ...
    gb_event_registers_map[0x10] = square1;
    gb_event_registers_map[0x11] = square1;
    gb_event_registers_map[0x12] = square1;
    gb_event_registers_map[0x13] = square1_write;
    gb_event_registers_map[0x14] = square1;
    ...
    gb_event_registers_map[0x16] = square2;
    gb_event_registers_map[0x17] = square2;
    gb_event_registers_map[0x18] = square2_write;
    gb_event_registers_map[0x19] = square2;
    ...
    gb_event_registers_map[0x1A] = wave;
    gb_event_registers_map[0x1B] = wave_write;
    gb_event_registers_map[0x1C] = wave;
    gb_event_registers_map[0x1D] = wave_write;
    gb_event_registers_map[0x1E] = wave;
    ...
    gb_event_registers_map[0x20] = noise_write;
    gb_event_registers_map[0x21] = noise;
    gb_event_registers_map[0x22] = noise;
    gb_event_registers_map[0x23] = noise;
    ...
    gb_event_registers_map[0x24] = apu_control;
    gb_event_registers_map[0x25] = apu_control;
    gb_event_registers_map[0x26] = apu_control;
    ...
    for(int i = 0x30; i <= 0x3F; ++i){
        gb_event_registers_map[i] = wave_ram;
    }
    ...
    gb_event_registers_map[0x40] = ppu;
    gb_event_registers_map[0x41] = ppu;
    gb_event_registers_map[0x42] = ppu;
    gb_event_registers_map[0x43] = ppu;
    gb_event_registers_map[0x44] = ppu_read;
    gb_event_registers_map[0x45] = ppu;
    gb_event_registers_map[0x4A] = ppu;
    gb_event_registers_map[0x4B] = ppu;
    ...
    gb_event_registers_map[0x47] = palette;
    gb_event_registers_map[0x48] = palette;
    gb_event_registers_map[0x49] = palette;
    ...
    gb_event_registers_map[0x46] = dma;
    gb_event_registers_map[0x51] = dma_write;
    gb_event_registers_map[0x52] = dma_write;
    gb_event_registers_map[0x53] = dma_write;
    gb_event_registers_map[0x54] = dma_write;
    gb_event_registers_map[0x55] = dma;


    //Palette CGB
    gb_event_register_map_t palette_cgb_only = {
        .type = gb_event_palette_type,
        .flags = gb_event_write_flag | gb_event_read_flag,
        .cgb_mode_only = true
    };

    gb_event_registers_map[0x68] = palette_cgb_only;
    gb_event_registers_map[0x69] = palette_cgb_only;
    gb_event_registers_map[0x6A] = palette_cgb_only;
    gb_event_registers_map[0x6B] = palette_cgb_only;
    ...
    for(int i = 0x80; i <= 0xFE; ++i){
        gb_event_registers_map[i] = hram;
    }


    //Others
    gb_event_register_map_t others_cgb_only = {
        .type = gb_event_others_type,
        .flags = gb_event_write_flag | gb_event_read_flag,
        .cgb_mode_only = true
    };
    gb_event_register_map_t others_write = {
        .type = gb_event_others_type,
        .flags = gb_event_write_flag,
        .cgb_mode_only = false
    };
    ...
    gb_event_registers_map[0x4C] = others_cgb_only;
    gb_event_registers_map[0x4D] = others_cgb_only;
    gb_event_registers_map[0x4F] = others_cgb_only;
    gb_event_registers_map[0x50] = others_write;
    gb_event_registers_map[0x56] = others_cgb_only;
    gb_event_registers_map[0x6C] = others_cgb_only;
    gb_event_registers_map[0x70] = others_cgb_only;
    gb_event_registers_map[0x76] = others_read;
    gb_event_registers_map[0x77] = others_read;
}
...
void gb_event_manager_screen_put_color(gb_t* gb,uint8_t scanline,uint16_t cycle,gb_rgb_t *color){
    ...
    uint8_t* pixel = event_manager->screen + (scanline * gb_event_screen_pitch) + (cycle * gb_event_screen_bytes_per_pixel);
...
void gb_event_manager_screen_blank(gb_t* gb){
    ...
    const gb_rgb_t color = gb_event_colors[gb_event_hblank_color];
...
void gb_event_manager_halt(gb_t* gb){
    ...
    gb_event_manager_push_event(&gb->event_manager,&event);
}
...
void gb_event_manager_io(gb_t* gb,uint8_t flag,uint8_t value,uint16_t address){
    ...
    if(address >= 0x8000 && address <= 0x9FFF){
        ...
        gb_event_register_map_t* map = gb_event_registers_map + (address & 0xFF);
        
        if(map->type != gb_event_none_type && (map->flags & flag) != 0){
            
            if(!map->cgb_mode_only || (gb->is_cgb && (gb->cgb_mode || gb->boot.mapped))){
